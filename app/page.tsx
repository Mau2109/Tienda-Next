...
async function getFeaturedProducts(): Promise<Product[]> {
  try {
    // Limitamos a 3 productos para la página principal
    const response = await fetch("https://fakestoreapi.com/products?limit=3", { next: { revalidate: 3600 } })
    ...
    <div className="space-y-8">
      <section className="rounded-lg overflow-hidden relative h-80 bg-gradient-to-r from-purple-900 to-blue-900">
        <div className="relative h-full flex flex-col justify-center p-8">
          <h1 className="text-4xl font-bold text-white mb-4">Bienvenido a Shooping</h1>
