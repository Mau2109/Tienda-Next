  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400">Conoce más sobre nuestra tienda y nuestra misión</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="space-y-6">
          <div className="border border-gray-200 dark:border-gray-800 rounded-lg bg-white dark:bg-gray-800">
            <div className="p-4 border-b border-gray-200 dark:border-gray-800">
              <h2 className="font-semibold text-lg">Nuestra Historia</h2>
              <p className="text-sm text-gray-500 dark:text-gray-400">Cómo comenzamos y hacia dónde vamos</p>
            </div>
          ...
          <div className="border border-gray-200 dark:border-gray-800 rounded-lg bg-white dark:bg-gray-800">
            <div className="p-4 border-b border-gray-200 dark:border-gray-800">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">Lo que nos impulsa cada día</p>
            </div>
            <div className="p-4 space-y-4 text-gray-700 dark:text-gray-300">
              <p>
        ...
        <div className="space-y-6">
          <div className="border border-gray-200 dark:border-gray-800 rounded-lg bg-white dark:bg-gray-800">
            <div className="p-4 border-b border-gray-200 dark:border-gray-800">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">Principios que guían nuestras decisiones</p>
            </div>
            <div className="p-4">
              <ul className="space-y-4 text-gray-700 dark:text-gray-300">
                <li>
                  <h3 className="font-medium text-gray-900 dark:text-white">Calidad</h3>
                  <p>Seleccionamos cuidadosamente cada producto para garantizar la mejor calidad.</p>
                </li>
                <hr className="my-2 border-gray-200 dark:border-gray-700" />
                <li>
                  <h3 className="font-medium text-gray-900 dark:text-white">Innovación</h3>
                  <p>Buscamos constantemente nuevas tendencias y productos para ofrecer lo mejor.</p>
                </li>
                <hr className="my-2 border-gray-200 dark:border-gray-700" />
                <li>
                  <h3 className="font-medium text-gray-900 dark:text-white">Servicio al Cliente</h3>
                  <p>Nuestros clientes son nuestra prioridad, y trabajamos para superar sus expectativas.</p>
                </li>
                <hr className="my-2 border-gray-200 dark:border-gray-700" />
                <li>
                  <h3 className="font-medium text-gray-900 dark:text-white">Sostenibilidad</h3>
          ...
          <div className="border border-gray-200 dark:border-gray-800 rounded-lg bg-white dark:bg-gray-800">
            <div className="p-4 border-b border-gray-200 dark:border-gray-800">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">Estamos aquí para ayudarte</p>
            </div>
            <div className="p-4">
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <span className="text-purple-500">📍</span>
                  <span className="text-gray-700 dark:text-gray-300">Av. Dr Modesto Seara Acatlima, Huajuapan de Leon, Oaxaca, Mex</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="text-blue-500">📞</span>
                  <span className="text-gray-700 dark:text-gray-300">+953 194 15 89</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="text-purple-500">📧</span>
                  <span className="text-gray-700 dark:text-gray-300">oorm030921@gs.utm.mx</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="text-purple-500">📧</span>
                  <span className="text-gray-700 dark:text-gray-300">mauriosorio444@gmail.com</span>
                </li>
              </ul>
            </div>
          </div>
